...
enqueued.*/
void MUARTBridge::send_packet(const Packet &packet_to_send) {
...
void MUARTBridge::write_raw_packet_(const RawPacket &packet_to_send) const {
...
the packet.
*/
optional<RawPacket> MUARTBridge::receive_raw_packet_(const SourceBridge source_bridge,
